...
function showIntro() {
  clearScreen();
  console.log("pausing combat music");
  if (MUSIC) {
    gameoverMusic.pause();
  ...
  startText.click = function(e) {
    ...
    console.log("jaja!"); setTimeout(setup, 0)}; 
  ...
  introText.click = function(e) {console.log("jaja!"); console.log(e)}; 
}
  ...
  for (var i = 0; i<nBlocks; i++) {
    ...
    let indestructible = false;
		if(indes.indexOf(i) != -1) {
			console.log("this one will be indestructible");
			indestructible = true;
...
function displayMenu() {
  ...
  app.stage.addChild(titleText);
  titleText.interactive = true;
  titleText.click = function(e) {console.log("jojojojojo!"); console.log(e)};
  ...
  introText.click = function(e) {
    ...
    console.log("jaja!"); setTimeout(showIntro, 0)};
}
